        ...
        <div class="card-body">
            <div class="row">
                <div class="col">
                    ...
                    <p style="color: wheat">Search up for articles that are related to a topic. The result will be shown
                        below.</p>
                </div>
                <div class="col">
                    <div class="input-group mb-3 input-group-lg">
                        ...
                        <input class="form-control align-items-center" style="margin-top: 30px" id="topic-search"
                               name="topic-search" type="search" placeholder="Type Something..." aria-label="Search">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card post-container">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col">
                    <a href="{{url('/protected/createtalk')}}" class="btn btn-lg btn-outline-light"
                       style="margin: 30px">Let's Talk!</a>
                </div>
            </div>
        </div>
    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-2 col-md-1 d-flex align-items-center">
                                                        <img
                                                            src="{{asset('imgs/site/userprivil'.$talk->user->userprivil.'.png')}}"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <p style="color: wheat">Not satisfying with the result? Go and select some certain topics
                                you need</p>
                        </div>
                        <div class="col">
                            <a href="{{url('/public/choosetopics')}}" class="btn btn-lg btn-outline-light"
                               style="margin: 40px">Choose My Topics</a>
                        </div>
                    </div>
                </div>
            </div>
