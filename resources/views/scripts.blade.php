...
<script src="{{url('https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js')}}"
        ...
        crossorigin="anonymous"></script>
<script src="{{url('https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js')}}"
        integrity="sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8shuf57BaghqFfPlYxofvL8/KUEfYiJOMMV+rV"
        crossorigin="anonymous"></script>

{{--Jquery Validator--}}
<script
    src="{{url('https://code.jquery.com/jquery-3.5.1.min.js')}}"
...
@unless(url()->current() == url('/public/signin') || url()->current() == url('/public/signup') || url()->current() == url('/public/handlereset'))
    <script type="text/javascript" color="47,135,193" opacity='0.5' zIndex="-2" count="199"
            src="{{url('http://cdn.bootcss.com/canvas-nest.js/1.0.1/canvas-nest.min.js')}}"></script>
@endunless

{{--Character--}}
<script
    src="{{url('https://eqcn.ajz.miesnfu.com/wp-content/plugins/wp-3d-pony/live2dw/lib/L2Dwidget.min.js')}}"></script>
<script>
    L2Dwidget.init({
        "model": {
        ...
        }, "mobile": {"show": true, "scale": 0.6, "motion": true},
