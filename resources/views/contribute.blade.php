...
@section('main')
    ...
    <div class="card-group">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                    Contribute an article that you think it's great for users. It can be math, computer science or other subjects.<br>
                    We highly appreciate your contribution. <br>
    ...
    <br>
    <small>P.S. If you want to upload a file(s) or image(s), please send it/them to my email at <a href="mailto:qq1955293190@gmail.com">qq1955293190@gmail.com</a></small>
    <br><br>
    <div id="contribute">
    </div>
